...
{
    [HtmlTargetElement("textbox", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class TextBoxForTagHelper : TagHelper
    {
        private const string ForAttributeName = "for";

        protected IHtmlGenerator Generator { get; set; }

        public TextBoxForTagHelper(IHtmlGenerator gen)
        {
            Generator = gen;
        }
